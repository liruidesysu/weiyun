...
function checkNameChz(value) {
    //var reg = /^[a-zA-Z0-9][a-zA-Z0-9_\-\.]{0,128}$/;
    var reg = /^[\u4e00-\u9fa5_a-zA-Z0-9\-\.]{1,64}$/;
    return reg.test(value);
}
...
jQuery.validator.addMethod("portusable", function(value, element) {
...
jQuery.validator.addMethod("isnamechz", function (value, element) {
    return this.optional(element) || checkNameChz(value);
}, "名称格式不正确");
...
$.validator.addMethod('MailisEmpty', function(value){
  return /\S/.test(value)
}, '邮箱地址不能为空');

$.validator.addMethod('MailIncludeAt', function(value, element){
  return this.optional(element) || /@/.test(value)
}, '邮箱地址必须包含@');

$.validator.addMethod('MailisDomain', function(value, element){
  return this.optional(element) || value.search(/@/) != value.length - 1
}, '请输入邮箱域名');

$.validator.addMethod('MailDomainCheck', function(value, element){
  var reg = /@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$/
  return this.optional(element) || reg.test(value)
}, '邮箱域名不合法');

$.validator.addMethod('MailFullCheck', function(value, element){
